...
from attrreal.configs.loader import register_schema
...
def _load_stage_registry(package: str = "attrreal") -> dict:
...
def _run_stages(cfg: DictConfig, run_dir: Path) -> dict:
    ...
    if unavailable:
        ...
        print(f"      in attrreal.stages: {unavailable}")
...
def main(cfg: DictConfig) -> None:
    ...
    from attrreal.configs.loader import config_to_dict, save_resolved_config
    from attrreal.models.device import get_device
    from attrreal.utils.logging import configure_logging
    from attrreal.utils.reproducibility import set_seed
    from attrreal.utils.run_manifest import create_run_dir, save_run_metadata
