...
def _compose(preset: str | None, overrides: list[str]):
    from attrreal.configs.loader import load_config
...
def _smoke_one(preset: str | None, args: argparse.Namespace) -> int:
    from attrreal.configs.loader import save_resolved_config
    from attrreal.utils.git import git_state
...
def main(argv: list[str] | None = None) -> int:
    ...
    from attrreal.configs.loader import available_presets
