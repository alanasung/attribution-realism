...
This note situates **When Data Attribution Breaks Outside Toy Settings** against the motivating literature for
[When Data Attribution Breaks Outside Toy Settings](https://github.com/alanasung/attribution-realism).

## Positioning

Measure where influence-style attribution degrades as data and model settings become more realistic.

The design hypothesis is: Measure where influence-style attribution degrades as data and model settings become more realistic.
