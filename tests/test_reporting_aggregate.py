import json
from attrreal.reporting.aggregate import aggregate_results, flatten_metrics
from attrreal.reporting.tables import write_tables
from attrreal.reporting.figures import write_caption, write_figures
