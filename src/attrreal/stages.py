"""Experiment stages for When Data Attribution Breaks Outside Toy Settings."""
...
from .attrreal._util import ensure_dir, stage_result, write_json
...
def stage_report(cfg: DictConfig, run_dir: Path) -> dict[str, Any]:
    ...
    write_json(
        out / "report.json",
        {"headline": "When Data Attribution Breaks Outside Toy Settings", "claims_gated": True},
    )
