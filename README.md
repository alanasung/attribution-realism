<p align="center">
  ...
  <p align="center">SPAR Fall 2026 · <a href="https://github.com/alanasung/attribution-realism">When Data Attribution Breaks Outside Toy Settings</a></p>
</p>
...
**When Data Attribution Breaks Outside Toy Settings**. The shared engineering spine (config, caching, hooks, metrics,
...
| Stage | Module | Output |
|---|---|---|
| Compose config | `configs/` + `attrreal.configs` | resolved `config.yaml` |
| Build data | `attrreal.data` | splits + manifest |
| Load model | `attrreal.models` | `LoadedModel` + resolved commit |
| Run stages | `scripts/run_experiment.py` | per-stage JSON |
| Aggregate | `attrreal.reporting` | `results.json` + tables + figures |
...
├── src/attrreal/       # installable library (print-free)
...
- SPAR Fall 2026 project posting: https://github.com/alanasung/attribution-realism
- Complexity bar: Critical Data PRIMED-AI / RecursiveJEPA engineering standard

## Citation

```bibtex
@misc{attrreal_spar_f26,
  title        = {When Data Attribution Breaks Outside Toy Settings},
  author       = {Alana Sung},
  year         = {2026},
  howpublished = {SPAR Fall 2026},
  note         = {Measure where influence-style attribution degrades as data and model settings become more realistic.},
  url          = {https://github.com/alanasung/attribution-realism}
}
```
...
Ablations live under `src/attrreal/ablation/` and return structured dicts. Presets
